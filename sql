...
create table account(id serial, login varchar(32), email varchar(255), avatar varchar(255), ip varchar(15), PRIMARY KEY(id));
create table pendinglogin(token varchar(96), accountId integer, PRIMARY KEY(token));
create table pollDoc (id integer, json text);
create table tag(tag text, polls text, timestamp bigint, PRIMARY KEY(tag));